  ...
  return (
    <div>
      <footer className="footer footer-center p-10 bg-neutral text-neutral-content rounded">
        <div>
          <h1 className="font-gilda  text-3xl font-extrabold">JUTE WOOD DECOR</h1>
        </div>
        <div>
          <h1 className="text-">
        ...
        <nav className="grid grid-flow-col gap-4">
          ...
          <Link to='/allCraftItems' className="link link-hover">All Art & Craft Item</Link>
          <Link to='/myCraftList' className="link link-hover">Your Art & Craft List</Link>
